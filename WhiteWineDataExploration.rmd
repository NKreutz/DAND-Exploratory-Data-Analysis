...
least 3 experts). The [data set](https://docs.google.com/document/d/1qEcwltBMlRYZT-l699-71TzInWfk4W9q5rTCSvDVMpc/pub?embedded=true) was obtained via [Udacity's Data Analyst Nanodegree Program](https://www.udacity.com/course/data-analyst-nanodegree--nd002). For more detailed information, see this [text file](https://s3.amazonaws.com/udacity-hosted-downloads/ud651/wineQualityInfo.txt). 
...
instead of "sweet". 
According to [winefolly.com](http://winefolly.com/tutorial/wine-sweetness-chart/),
...
<p><a href="https://commons.wikimedia.org/wiki/File:216_pH_Scale-01.jpg#/media/File:216_pH_Scale-01.jpg"><img src="https://upload.wikimedia.org/wikipedia/commons/2/23/216_pH_Scale-01.jpg" alt="216 pH Scale-01.jpg" width="400" height="800"></a><br>By OpenStax College - Anatomy &amp; Physiology, Connexions Web site. <a rel="nofollow" class="external free" href="http://cnx.org/content/col11496/1.6/">http://cnx.org/content/col11496/1.6/</a>, Jun 19, 2013., <a href="http://creativecommons.org/licenses/by/3.0" title="Creative Commons Attribution 3.0">CC BY 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=30131151">Link</a></p>
...
According to the [data description](https://s3.amazonaws.com/udacity-hosted-downloads/ud651/wineQualityInfo.txt), Sulphates contribute to the Free and Total Sulfur Dioxide contents:
...
~9.5% alcohol and a range from 8%-14.2%. According to [wikipedia](https://en.wikipedia.org/wiki/Alcohol_by_volume), wine typically has 
...
just a placeholder. Since this visualization is hard to see, I'll also export it 
as a pdf (scatterplot_matrix.pdf). 

```{r echo=FALSE, warning=FALSE, message=FALSE}
ggpairs(subset(white.wine, select = -X))
ggsave("scatterplot_matrix.pdf", width = 13, height = 13)
```
